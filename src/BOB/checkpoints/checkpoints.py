...
SAM2_finetuned_1k = "src/segFM/BAGLS/SAMv2/finetuned/bagls_tuned_sam2t_1000.torch"

### MedicalSAM2 ### https://github.com/SuperMedIntel/Medical-SAM2
MedicalSAM2 = "Models/sam2/checkpoints/MedicalSAM2.pth"
MedicalSAM2_cfg = "configs/sam2/sam2_hiera_l.yaml"

### MedSAM2 ### https://github.com/bowang-lab/MedSAM2
MedSAM_cfg = "configs/sam2.1_hiera_t512.yaml"

MedSAM2CT = "src/segFM/predictors/MedSAM2/checkpoints/MedSAM2_CTLesion.pt"
